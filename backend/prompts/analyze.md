...
confidence(0-100): 직접 증거(반사·파일읽기·명령출력·시간지연 일치 등)가 있으면 85-100, 증거가 없어 attack_success 가 inconclusive 면 50-70 — inconclusive 에 90 이상을 주지 마세요.
...
reasoning·remediation·evidence·vulnerability 는 한국어로 작성하세요(단, evidence 안의 payload·시그니처·헤더명 등 원문 토큰은 그대로).
